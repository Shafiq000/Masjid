...
import { StyleSheet, Text, View, SafeAreaView, Image, TextInput, Pressable, ScrollView, Alert } from 'react-native';
...
const PhoneSignUp = ({ navigation }) => {
    ...
    const { themeMode,signInWithPhoneNumber  } = useAuthContext();
